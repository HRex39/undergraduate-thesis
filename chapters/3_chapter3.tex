...
\begin{table}[htbp]
    ...
    ego-vehicle & \multicolumn{1}{c}{$x_{ego}$}   & \multicolumn{1}{c}{$y_{ego}$}   & \multicolumn{1}{c}{$v_{xego}$}      &  $v_{yego}$     \\ 
    vehicle 1   & \multicolumn{1}{c}{$x_1$} & \multicolumn{1}{c}{$y_1$} & \multicolumn{1}{c}{$v_{x1}$}   & $v_{y1}$   \\ 
    vehicle 2   & \multicolumn{1}{c}{$x_2$} & \multicolumn{1}{c}{$y_2$} & \multicolumn{1}{c}{$v_{x2}$}   & $v_{y2}$   \\ 
    $\dots$     & \multicolumn{4}{c}{$\dots$}                                                           \\ 
    vehicle n   & \multicolumn{1}{c}{$x_n$} & \multicolumn{1}{c}{$y_n$} & \multicolumn{1}{c}{$v_{xn}$}   & $v_{yn}$   \\ 
    \bottomrule %添加表格底部粗线
    \end{tabular}
    }
\end{table}
